...
- Every durable conclusion from `TODO.finish_process.md` exists in models, tests, current-state docs, or code; the TODO is then deleted. The next Grove traversal sees no unretired work in this mandate.
