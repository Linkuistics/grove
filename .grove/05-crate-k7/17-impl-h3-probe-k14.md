...
**Probe.** `insert`, implemented by `insert-k11`. Chosen because its
...
**Arm A — model-led.** The `insert` implementation as `insert-k11`
...
**Measure.** The model-claim-citing test suite from `insert-k11`,
...
arm — `insert-k11` carries no mention of this leaf — but the node
