...
Run and judge the pre-frozen external probe as a separate transfer claim, using
the same treatment, execution, access, assignment, and scoring discipline as the
same-case campaign.
...
`transfer-runs-k69` owns model execution and immutable raw records;
`transfer-adjudication-k70` owns deterministic audit, blind scoring, and the
separate transfer verdict.
