...
Make access validity, treatment exposure, assignment outcome, and scorer
blinding reproducible over the runner's preserved records.
...
- A narrow command grammar names the literal read-only commands and resolved
  operands permitted beneath the active target-skill directory and the declared
  run fixture. Compound commands, interpreters, expansion, redirection,
  symlink escapes, writes, MCP, web, connectors, and unclassified events have
...
- Full events feed the deterministic access audit. A separately generated,
  ...
  residual treatment disclosure, and unblindable cases follow frozen rules.
