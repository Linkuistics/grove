...
Apply the frozen primary acceptance contract across all three same-case records.
...
- Every frozen row and pair count is reproduced from the case records without a
