...
Publish the bounded recovery-cycle synthesis and state whether the unchanged
parent acceptance requirement is met.

## Context

- Historical synthesis to preserve and extend:
...
- The durable report preserves the old frozen campaign as historical evidence
...
- No skill refinement, old-output rescore, frozen-rubric rewrite, or
