...
- Treatment-neutral randomized bundles retain all evidence needed by the frozen
  ...
  bundle receives two independent blind scores with minimal citations.
- Each scorer records a forced arm guess after scoring and before reveal; guess
  accuracy is reported only as a supplemental blinding limitation.
