...
fn a_fragment_whose_bytes_are_not_its_own_declared_range_is_a_byte_failure() {
    // The two literals tile `library-crate-surface` (1-2, 3-111) and their
    ...
    let markdown = format!(
        concat!(
            ...
            "````rust\none\n````\n<!-- /fragment -->\n",
            "<!-- fragment «part-2» owner=\"orientation-k11\" source=\"crates/ordinal-fs-tree/src/lib.rs\" lines=\"3-111\" parent=\"library-crate-surface\" -->\n",
            "````rust\ntwo\n{}````\n<!-- /fragment -->\n",
        ),
        "line\n".repeat(109)
    );
