...
| `source-command-surface` | `crates/grove-llm/src/cli.rs` | 964 |
...
<!-- insert «entry-point» -->
<!-- /source-root -->
<!-- source-root «source-command-surface» source="crates/grove-llm/src/cli.rs" lines="1-964" -->
...
| `run-admission-and-dispatch` | `source-command-surface` | `admitted-before-dispatch` | `412-459` | 48 | `resolved` |
| `handlers-leaving` | `source-command-surface` | `admit-before-signal` | `460-502` | 43 | `resolved` |
| `handler-root-init` | `source-command-surface` | `before-the-lock` | `503-532` | 30 | `resolved` |
| `handlers-reading-and-rendering` | `source-command-surface` | `information-not-error` | `533-656` | 124 | `resolved` |
| `handlers-growing` | `source-command-surface` | `before-the-lock` | `657-787` | 131 | `resolved` |
| `handlers-ending` | `source-command-surface` | `two-steps-remain` | `788-845` | 58 | `resolved` |
| `presence-rule-and-slug` | `source-command-surface` | `before-the-lock` | `846-882` | 37 | `resolved` |
| `openings` | `source-command-surface` | `admitted-before-dispatch` | `883-923` | 41 | `resolved` |
| `path-and-label-helpers` | `source-command-surface` | `information-not-error` | `924-964` | 41 | `resolved` |
...
| `run-parse-cli` | `the-grammar` | `source-command-surface` | `literal` | `admitted-before-dispatch` | `412-419` | `run-parse-and-bare-branch` | `—` |
| `run-parse-and-bare-branch` | `the-grammar` | `source-command-surface` | `composite` | `admitted-before-dispatch` | `412-441` | `run-admission-and-dispatch` | `run-parse-cli`, `run-standalone-completion` |
| `run-admission-and-dispatch` | `the-grammar` | `source-command-surface` | `composite` | `admitted-before-dispatch` | `412-459` | `source-command-surface` | `run-parse-and-bare-branch`, `run-cwd-and-admission`, `run-dispatch` |
| `run-standalone-completion` | `the-grammar` | `source-command-surface` | `literal` | `admitted-before-dispatch` | `420-441` | `run-parse-and-bare-branch` | `—` |
| `run-cwd-and-admission` | `the-grammar` | `source-command-surface` | `literal` | `admitted-before-dispatch` | `442-443` | `run-admission-and-dispatch` | `—` |
| `run-dispatch` | `the-grammar` | `source-command-surface` | `literal` | `admitted-before-dispatch` | `444-459` | `run-admission-and-dispatch` | `—` |
| `handler-finish-commit` | `leaving-the-loop` | `source-command-surface` | `literal` | `admit-before-signal` | `460-477` | `handlers-leaving` | `—` |
| `handlers-leaving` | `leaving-the-loop` | `source-command-surface` | `composite` | `admit-before-signal` | `460-502` | `source-command-surface` | `handler-finish-commit`, `handler-complete-admit`, `handler-complete-endings` |
| `handler-complete-admit` | `leaving-the-loop` | `source-command-surface` | `literal` | `admit-before-signal` | `478-485` | `handlers-leaving` | `—` |
| `handler-complete-endings` | `leaving-the-loop` | `source-command-surface` | `literal` | `admit-before-signal` | `486-502` | `handlers-leaving` | `—` |
| `handler-root-init-text` | `growing-the-tree` | `source-command-surface` | `literal` | `before-the-lock` | `503-510` | `handler-root-init` | `—` |
| `handler-root-init` | `growing-the-tree` | `source-command-surface` | `composite` | `before-the-lock` | `503-532` | `source-command-surface` | `handler-root-init-text`, `handler-root-init-vacancy` |
...
| `handler-leaf-add` | `growing-the-tree` | `source-command-surface` | `literal` | `before-the-lock` | `657-671` | `handlers-growing` | `—` |
| `handlers-growing` | `growing-the-tree` | `source-command-surface` | `composite` | `before-the-lock` | `657-787` | `source-command-surface` | `handler-leaf-add`, `print-paths`, `handler-leaf-insert`, `report-insert`, `handler-leaf-decompose-head`, `handler-leaf-decompose-kind`, `inherited-kind` |
| `print-paths` | `growing-the-tree` | `source-command-surface` | `literal` | `before-the-lock` | `672-681` | `handlers-growing` | `—` |
| `handler-leaf-insert` | `growing-the-tree` | `source-command-surface` | `literal` | `before-the-lock` | `682-692` | `handlers-growing` | `—` |
| `report-insert` | `growing-the-tree` | `source-command-surface` | `literal` | `before-the-lock` | `693-737` | `handlers-growing` | `—` |
| `handler-leaf-decompose-head` | `growing-the-tree` | `source-command-surface` | `literal` | `before-the-lock` | `738-744` | `handlers-growing` | `—` |
| `handler-leaf-decompose-kind` | `growing-the-tree` | `source-command-surface` | `literal` | `before-the-lock` | `745-776` | `handlers-growing` | `—` |
| `inherited-kind` | `growing-the-tree` | `source-command-surface` | `literal` | `before-the-lock` | `777-787` | `handlers-growing` | `—` |
| `eprint-next-steps` | `ending-work` | `source-command-surface` | `literal` | `two-steps-remain` | `788-805` | `handlers-ending` | `—` |
| `handlers-ending` | `ending-work` | `source-command-surface` | `composite` | `two-steps-remain` | `788-845` | `source-command-surface` | `eprint-next-steps`, `handler-leaf-retire`, `handler-leaf-prune-marks`, `handler-leaf-prune-reminder` |
| `handler-leaf-retire` | `ending-work` | `source-command-surface` | `literal` | `two-steps-remain` | `806-815` | `handlers-ending` | `—` |
| `handler-leaf-prune-marks` | `ending-work` | `source-command-surface` | `literal` | `two-steps-remain` | `816-836` | `handlers-ending` | `—` |
| `handler-leaf-prune-reminder` | `ending-work` | `source-command-surface` | `literal` | `two-steps-remain` | `837-845` | `handlers-ending` | `—` |
| `require-declared` | `growing-the-tree` | `source-command-surface` | `literal` | `before-the-lock` | `846-874` | `presence-rule-and-slug` | `—` |
| `presence-rule-and-slug` | `growing-the-tree` | `source-command-surface` | `composite` | `before-the-lock` | `846-882` | `source-command-surface` | `require-declared`, `slug` |
| `slug` | `growing-the-tree` | `source-command-surface` | `literal` | `before-the-lock` | `875-882` | `presence-rule-and-slug` | `—` |
| `openings-worktree` | `the-grammar` | `source-command-surface` | `literal` | `admitted-before-dispatch` | `883-890` | `openings` | `—` |
| `openings` | `the-grammar` | `source-command-surface` | `composite` | `admitted-before-dispatch` | `883-923` | `source-command-surface` | `openings-worktree`, `openings-readable`, `openings-writable`, `openings-absent` |
| `openings-readable` | `the-grammar` | `source-command-surface` | `literal` | `admitted-before-dispatch` | `891-904` | `openings` | `—` |
| `openings-writable` | `the-grammar` | `source-command-surface` | `literal` | `admitted-before-dispatch` | `905-913` | `openings` | `—` |
| `openings-absent` | `the-grammar` | `source-command-surface` | `literal` | `admitted-before-dispatch` | `914-923` | `openings` | `—` |
| `helper-normalize-leaf-path` | `reading-the-tree` | `source-command-surface` | `literal` | `information-not-error` | `924-947` | `path-and-label-helpers` | `—` |
| `path-and-label-helpers` | `reading-the-tree` | `source-command-surface` | `composite` | `information-not-error` | `924-964` | `source-command-surface` | `helper-normalize-leaf-path`, `helper-label`, `helper-no-live-leaves` |
| `helper-label` | `reading-the-tree` | `source-command-surface` | `literal` | `information-not-error` | `948-956` | `path-and-label-helpers` | `—` |
| `helper-no-live-leaves` | `reading-the-tree` | `source-command-surface` | `literal` | `information-not-error` | `957-964` | `path-and-label-helpers` | `—` |
