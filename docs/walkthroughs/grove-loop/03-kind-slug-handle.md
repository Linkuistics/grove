...
The chapter owns 563 of the file's 1,714 lines in three blocks — the named parts
themselves at lines 221 to 590, and the two labelled sections of the inline test
module that hold this chapter's claims, at 1,522 to 1,550 and 1,551 to 1,714. The
...
<!-- fragment «slug-rule-tests» owner="the-handle-not-the-position" source="crates/grove-loop/src/task_name.rs" lines="1522-1550" parent="source-task-name" -->
````rust
    // ---- the slug rule ------------------------------------------------------
...
<!-- fragment «handle-grammar-tests» owner="the-handle-not-the-position" source="crates/grove-loop/src/task_name.rs" lines="1551-1714" parent="source-task-name" -->
...
<!-- fragment «name-tests-ends-in-handle» owner="the-handle-not-the-position" source="crates/grove-loop/src/task_name.rs" lines="1551-1601" parent="handle-grammar-tests" -->
````rust
...
<!-- fragment «name-tests-brief-no-handle» owner="the-handle-not-the-position" source="crates/grove-loop/src/task_name.rs" lines="1602-1608" parent="handle-grammar-tests" -->
````rust
...
<!-- fragment «name-tests-handle-round-trip» owner="the-handle-not-the-position" source="crates/grove-loop/src/task_name.rs" lines="1609-1628" parent="handle-grammar-tests" -->
````rust
...
<!-- fragment «name-tests-same-peel» owner="the-handle-not-the-position" source="crates/grove-loop/src/task_name.rs" lines="1629-1650" parent="handle-grammar-tests" -->
````rust
...
<!-- fragment «name-tests-refused-handle» owner="the-handle-not-the-position" source="crates/grove-loop/src/task_name.rs" lines="1651-1684" parent="handle-grammar-tests" -->
````rust
...
<!-- fragment «name-tests-lenient-strict» owner="the-handle-not-the-position" source="crates/grove-loop/src/task_name.rs" lines="1685-1714" parent="handle-grammar-tests" -->
````rust
