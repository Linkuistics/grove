...
<!-- fragment «resolution» owner="wider-than-a-key" source="crates/grove-loop/src/task_tree.rs" lines="719-1001" parent="source-task-tree" -->
...
<!-- fragment «resolution-outcome» owner="wider-than-a-key" source="crates/grove-loop/src/task_tree.rs" lines="719-737" parent="resolution" -->
````rust
...
<!-- fragment «resolution-located» owner="wider-than-a-key" source="crates/grove-loop/src/task_tree.rs" lines="738-759" parent="resolution" -->
````rust
...
<!-- fragment «resolution-located-fn» owner="wider-than-a-key" source="crates/grove-loop/src/task_tree.rs" lines="760-782" parent="resolution" -->
````rust
...
<!-- fragment «resolution-resolve-in» owner="wider-than-a-key" source="crates/grove-loop/src/task_tree.rs" lines="783-823" parent="resolution" -->
````rust
...
<!-- fragment «resolution-lookup-type» owner="wider-than-a-key" source="crates/grove-loop/src/task_tree.rs" lines="824-836" parent="resolution" -->
````rust
...
<!-- fragment «resolution-slug-match-key» owner="wider-than-a-key" source="crates/grove-loop/src/task_tree.rs" lines="837-847" parent="resolution" -->
````rust
...
<!-- fragment «resolution-grammar» owner="wider-than-a-key" source="crates/grove-loop/src/task_tree.rs" lines="848-898" parent="resolution" -->
````rust
...
<!-- fragment «resolution-reference» owner="wider-than-a-key" source="crates/grove-loop/src/task_tree.rs" lines="899-942" parent="resolution" -->
````rust
...
<!-- fragment «resolution-existing-path» owner="wider-than-a-key" source="crates/grove-loop/src/task_tree.rs" lines="943-961" parent="resolution" -->
````rust
...
<!-- fragment «resolution-ref-type» owner="wider-than-a-key" source="crates/grove-loop/src/task_tree.rs" lines="962-967" parent="resolution" -->
````rust
...
<!-- fragment «resolution-parse-ref» owner="wider-than-a-key" source="crates/grove-loop/src/task_tree.rs" lines="968-990" parent="resolution" -->
````rust
...
<!-- fragment «resolution-read-count» owner="wider-than-a-key" source="crates/grove-loop/src/task_tree.rs" lines="991-1001" parent="resolution" -->
````rust
...
chapter 7's nineteen over 252, though it is the least test-heavy of the three by
proportion: 344 of this chapter's 613 owned lines are tests, against chapter 8's
334 of 443 and chapter 7's 252 of 336.
...
<!-- fragment «resolve-tests» owner="wider-than-a-key" source="crates/grove-loop/src/task_tree.rs" lines="1654-1974" parent="source-task-tree" -->
...
<!-- fragment «resolve-tests-fixture» owner="wider-than-a-key" source="crates/grove-loop/src/task_tree.rs" lines="1654-1692" parent="resolve-tests" -->
````rust
    // ---- resolve ------------------------------------------------------------
...
<!-- fragment «resolve-tests-bracket-key» owner="wider-than-a-key" source="crates/grove-loop/src/task_tree.rs" lines="1693-1705" parent="resolve-tests" -->
````rust
    #[test]
...
<!-- fragment «resolve-tests-bare-number» owner="wider-than-a-key" source="crates/grove-loop/src/task_tree.rs" lines="1706-1717" parent="resolve-tests" -->
````rust
    #[test]
...
<!-- fragment «resolve-tests-pruned» owner="wider-than-a-key" source="crates/grove-loop/src/task_tree.rs" lines="1718-1746" parent="resolve-tests" -->
````rust
    #[test]
...
<!-- fragment «resolve-tests-decorative-slug» owner="wider-than-a-key" source="crates/grove-loop/src/task_tree.rs" lines="1747-1758" parent="resolve-tests" -->
````rust
    #[test]
...
<!-- fragment «resolve-tests-node-by-key» owner="wider-than-a-key" source="crates/grove-loop/src/task_tree.rs" lines="1759-1773" parent="resolve-tests" -->
````rust
    #[test]
...
<!-- fragment «resolve-tests-key-not-found» owner="wider-than-a-key" source="crates/grove-loop/src/task_tree.rs" lines="1774-1779" parent="resolve-tests" -->
````rust
    #[test]
...
<!-- fragment «resolve-tests-slug-unique» owner="wider-than-a-key" source="crates/grove-loop/src/task_tree.rs" lines="1780-1791" parent="resolve-tests" -->
````rust
    #[test]
...
<!-- fragment «resolve-tests-slug-nested» owner="wider-than-a-key" source="crates/grove-loop/src/task_tree.rs" lines="1792-1805" parent="resolve-tests" -->
````rust
    #[test]
...
<!-- fragment «resolve-tests-slug-not-found» owner="wider-than-a-key" source="crates/grove-loop/src/task_tree.rs" lines="1806-1811" parent="resolve-tests" -->
````rust
    #[test]
...
<!-- fragment «resolve-tests-ambiguous» owner="wider-than-a-key" source="crates/grove-loop/src/task_tree.rs" lines="1812-1833" parent="resolve-tests" -->
````rust
    #[test]
...
<!-- fragment «resolve-tests-root-brief» owner="wider-than-a-key" source="crates/grove-loop/src/task_tree.rs" lines="1834-1842" parent="resolve-tests" -->
````rust
    #[test]
...
<!-- fragment «resolve-tests-dot» owner="wider-than-a-key" source="crates/grove-loop/src/task_tree.rs" lines="1843-1852" parent="resolve-tests" -->
````rust
    #[test]
...
<!-- fragment «resolve-tests-empty-reference» owner="wider-than-a-key" source="crates/grove-loop/src/task_tree.rs" lines="1853-1857" parent="resolve-tests" -->
````rust
    #[test]
...
<!-- fragment «resolve-tests-malformed-bracket» owner="wider-than-a-key" source="crates/grove-loop/src/task_tree.rs" lines="1858-1864" parent="resolve-tests" -->
````rust
    #[test]
...
<!-- fragment «resolve-tests-absent-root» owner="wider-than-a-key" source="crates/grove-loop/src/task_tree.rs" lines="1865-1875" parent="resolve-tests" -->
````rust
    #[test]
...
<!-- fragment «resolve-handle-tests-full-handle» owner="wider-than-a-key" source="crates/grove-loop/src/task_tree.rs" lines="1876-1891" parent="resolve-tests" -->
````rust
...
<!-- fragment «resolve-handle-tests-terminal-key» owner="wider-than-a-key" source="crates/grove-loop/src/task_tree.rs" lines="1892-1918" parent="resolve-tests" -->
````rust
...
<!-- fragment «resolve-handle-tests-disambiguates» owner="wider-than-a-key" source="crates/grove-loop/src/task_tree.rs" lines="1919-1932" parent="resolve-tests" -->
````rust
    #[test]
...
<!-- fragment «resolve-handle-tests-node» owner="wider-than-a-key" source="crates/grove-loop/src/task_tree.rs" lines="1933-1945" parent="resolve-tests" -->
````rust
    #[test]
...
<!-- fragment «resolve-handle-tests-precedence» owner="wider-than-a-key" source="crates/grove-loop/src/task_tree.rs" lines="1946-1966" parent="resolve-tests" -->
````rust
    #[test]
...
<!-- fragment «resolve-handle-tests-unmatched» owner="wider-than-a-key" source="crates/grove-loop/src/task_tree.rs" lines="1967-1974" parent="resolve-tests" -->
````rust
    #[test]
