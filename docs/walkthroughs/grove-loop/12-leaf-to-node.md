...
<!-- fragment «decompose-production» owner="the-key-survives" source="crates/grove-loop/src/tree_lifecycle.rs" lines="490-695" parent="source-tree-lifecycle" -->
...
<!-- fragment «decompose-verb-contract» owner="the-key-survives" source="crates/grove-loop/src/tree_lifecycle.rs" lines="490-531" parent="decompose-production" -->
````rust
...
<!-- fragment «decompose-verb-body» owner="the-key-survives" source="crates/grove-loop/src/tree_lifecycle.rs" lines="532-590" parent="decompose-production" -->
````rust
...
<!-- fragment «decompose-decomposable» owner="the-key-survives" source="crates/grove-loop/src/tree_lifecycle.rs" lines="591-628" parent="decompose-production" -->
````rust
...
<!-- fragment «decompose-promoted-claims» owner="the-key-survives" source="crates/grove-loop/src/tree_lifecycle.rs" lines="629-644" parent="decompose-production" -->
````rust
...
<!-- fragment «decompose-promoted-body» owner="the-key-survives" source="crates/grove-loop/src/tree_lifecycle.rs" lines="645-695" parent="decompose-production" -->
````rust
fn promoted(
...
<!-- fragment «decompose-tests» owner="the-key-survives" source="crates/grove-loop/src/tree_lifecycle.rs" lines="1666-2234" parent="source-tree-lifecycle" -->
...
<!-- fragment «decompose-tests-opening» owner="the-key-survives" source="crates/grove-loop/src/tree_lifecycle.rs" lines="1666-1695" parent="decompose-tests" -->
````rust
    // ---- leaf-decompose -----------------------------------------------------
...
<!-- fragment «decompose-tests-brief-and-child» owner="the-key-survives" source="crates/grove-loop/src/tree_lifecycle.rs" lines="1696-1742" parent="decompose-tests" -->
````rust
    #[test]
...
<!-- fragment «decompose-tests-kind» owner="the-key-survives" source="crates/grove-loop/src/tree_lifecycle.rs" lines="1743-1822" parent="decompose-tests" -->
````rust
    #[test]
...
<!-- fragment «decompose-tests-nested» owner="the-key-survives" source="crates/grove-loop/src/tree_lifecycle.rs" lines="1823-1849" parent="decompose-tests" -->
````rust
    #[test]
...
<!-- fragment «decompose-tests-refusals» owner="the-key-survives" source="crates/grove-loop/src/tree_lifecycle.rs" lines="1850-1923" parent="decompose-tests" -->
````rust
    #[test]
...
<!-- fragment «decompose-tests-slug-and-path» owner="the-key-survives" source="crates/grove-loop/src/tree_lifecycle.rs" lines="1924-1970" parent="decompose-tests" -->
````rust
...
<!-- fragment «decompose-tests-seam-opening» owner="the-key-survives" source="crates/grove-loop/src/tree_lifecycle.rs" lines="1971-1978" parent="decompose-tests" -->
````rust
...
in the library at all. Those, with `NoDistinguishedChild`, are the three the sweep
...
<!-- fragment «decompose-tests-one-guard» owner="the-key-survives" source="crates/grove-loop/src/tree_lifecycle.rs" lines="1979-2007" parent="decompose-tests" -->
````rust
    #[test]
...
<!-- fragment «decompose-tests-twin» owner="the-key-survives" source="crates/grove-loop/src/tree_lifecycle.rs" lines="2008-2038" parent="decompose-tests" -->
````rust
    #[test]
...
<!-- fragment «decompose-tests-destination» owner="the-key-survives" source="crates/grove-loop/src/tree_lifecycle.rs" lines="2039-2108" parent="decompose-tests" -->
````rust
    #[test]
...
<!-- fragment «decompose-tests-interrupted» owner="the-key-survives" source="crates/grove-loop/src/tree_lifecycle.rs" lines="2109-2151" parent="decompose-tests" -->
````rust
    #[test]
...
<!-- fragment «decompose-tests-last-key» owner="the-key-survives" source="crates/grove-loop/src/tree_lifecycle.rs" lines="2152-2182" parent="decompose-tests" -->
````rust
    #[test]
...
<!-- fragment «decompose-tests-sweep» owner="the-key-survives" source="crates/grove-loop/src/tree_lifecycle.rs" lines="2183-2234" parent="decompose-tests" -->
````rust
    #[test]
...
**Two of the three are discharged without a tree at all.** `NoDistinguishedChild`
cannot fire because grove's domain *has* a distinguished child, which the first
assertion reads straight off the `EntryName` implementation chapter 4 owns:
`TaskName::distinguished()` is `Some`, so a promotion always has somewhere to put
the leaf's bytes. `PromotePartsNotNode` cannot fire because `leaf-decompose`
