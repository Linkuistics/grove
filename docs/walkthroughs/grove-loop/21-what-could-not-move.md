...
This chapter owns none of the crate's 14,594 lines. The fragment graph spans
...
**Owned source.** 504 + 373 + 529 + 773 + 521 + 320 + 336 + 438 + 604 + 518 + 641 + 764 + 808 + 521 + 514 + 1,149 + 3,824 + 460 + 245 + 752 = 14,594 lines across
...
inside that root's 371 lines, so the chapter now explains two repaired
...
page inventory must match the manifest exactly. Sixteen files, 14,594 resolved
...
<!-- rollup «owned-lines-total» -->
<!-- rollup «chapters» -->
The book is complete: 16 roots, 14,594 lines, 21 chapters, two
