...
`crates/grove-loop` is thirteen files and 10,562 lines, and it is the layer that
...
All three are provable inside these 10,562 lines, and the closing chapter applies
...
proves complete reconstruction of all thirteen files and 10,562 lines.
