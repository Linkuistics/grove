...
<!-- defer «workspace-value-and-gate» owner="one-lane" lines="72-118" -->
...
<!-- defer «gate-main-repo-and-canonical» owner="one-lane" lines="275-319" -->
...
|---|---|---|---|---|
| `Workspace` | `01-orientation.md#public-surface` | `one-lane` | A resolved workspace is a value whose existence is the proof that the precondition passed; it carries the workspace root and the root of the workspace that holds the repository. | `pending` |
