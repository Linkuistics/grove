...
<!-- fragment «word-scanning» owner="words-not-shell" source="crates/keyed-launch/src/templates.rs" lines="572-621" parent="source-templates" -->
````rust
...
<!-- fragment «diagnostics» owner="words-not-shell" source="crates/keyed-launch/src/templates.rs" lines="622-692" parent="source-templates" -->
````rust
