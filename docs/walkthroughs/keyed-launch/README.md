...
`crates/keyed-launch` is 11 files and 3,399 lines, and it is the layer between
...
what the operator did not write. All three are provable inside these 3,399 lines,
...
proves complete reconstruction of all 11 files and 3,399 lines.
