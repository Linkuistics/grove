...
| `source-named` | `crates/keyed-launch/src/templates/named.rs` | 1,158 |

<!-- source-root «source-crate-manifest» source="crates/keyed-launch/Cargo.toml" lines="1-47" -->
<!-- insert «manifest-three-dependencies» -->
<!-- /source-root -->
<!-- source-root «source-library-root» source="crates/keyed-launch/src/lib.rs" lines="1-98" -->
<!-- insert «library-root» -->
<!-- /source-root -->
...
<!-- insert «vocabulary» -->
<!-- /source-root -->
<!-- source-root «source-templates» source="crates/keyed-launch/src/templates.rs" lines="1-985" -->
...
<!-- source-root «source-named» source="crates/keyed-launch/src/templates/named.rs" lines="1-1158" -->
...
| `library-root` | `source-library-root` | `understands-neither` | `1-98` | 98 | `resolved` |
...
| `templates-load` | `source-templates` | `never-assembled` | `165-281` | 117 | `resolved` |
| `resolution-and-expansion` | `source-templates` | `whole-word-or-nothing` | `282-463` | 182 | `resolved` |
| `reading-and-whole-document-validation` | `source-templates` | `never-assembled` | `464-672` | 209 | `resolved` |
| `node-and-template-rules` | `source-templates` | `words-not-shell` | `673-812` | 140 | `resolved` |
| `word-scanning` | `source-templates` | `words-not-shell` | `813-895` | 83 | `resolved` |
| `diagnostics` | `source-templates` | `words-not-shell` | `896-975` | 80 | `resolved` |
| `templates-keys` | `source-templates` | `whole-word-or-nothing` | `976-985` | 10 | `resolved` |
...
| `named-capture` | `source-named` | `never-assembled` | `1-404` | 404 | `resolved` |
| `named-diagnostics` | `source-named` | `never-assembled` | `405-420` | 16 | `resolved` |
| `named-compile` | `source-named` | `words-not-shell` | `421-558` | 138 | `resolved` |
| `named-fold` | `source-named` | `never-assembled` | `559-799` | 241 | `resolved` |
| `named-resolve` | `source-named` | `never-assembled` | `800-1123` | 324 | `resolved` |
| `named-lookups` | `source-named` | `never-assembled` | `1124-1158` | 35 | `resolved` |
...
| `source-library-root` | `source-index` | `source-library-root` | `root` | `—` | `1-98` | `—` | `library-root` |
| `library-root-thesis` | `orientation` | `source-library-root` | `literal` | `understands-neither` | `1-8` | `library-root` | `—` |
| `library-root` | `orientation` | `source-library-root` | `composite` | `understands-neither` | `1-98` | `source-library-root` | `library-root-thesis`, `library-root-two-documents`, `library-root-vocabulary`, `library-root-to-a-child`, `library-root-job-and-out-of-band`, `library-root-conformance`, `library-root-modules-and-exports` |
| `library-root-two-documents` | `orientation` | `source-library-root` | `literal` | `understands-neither` | `9-21` | `library-root` | `—` |
| `library-root-vocabulary` | `orientation` | `source-library-root` | `literal` | `understands-neither` | `22-42` | `library-root` | `—` |
| `library-root-to-a-child` | `orientation` | `source-library-root` | `literal` | `understands-neither` | `43-52` | `library-root` | `—` |
| `library-root-job-and-out-of-band` | `orientation` | `source-library-root` | `literal` | `understands-neither` | `53-65` | `library-root` | `—` |
| `library-root-conformance` | `orientation` | `source-library-root` | `literal` | `understands-neither` | `66-75` | `library-root` | `—` |
| `library-root-modules-and-exports` | `orientation` | `source-library-root` | `literal` | `understands-neither` | `76-98` | `library-root` | `—` |
...
| `source-templates` | `source-index` | `source-templates` | `root` | `—` | `1-985` | `—` | `template-shapes`, `templates-load`, `resolution-and-expansion`, `reading-and-whole-document-validation`, `node-and-template-rules`, `word-scanning`, `diagnostics`, `templates-keys` |
...
| `templates-load` | `two-documents` | `source-templates` | `composite` | `never-assembled` | `165-281` | `source-templates` | `templates-load-three-promises`, `templates-load-primary`, `templates-load-overlay`, `templates-load-value` |
| `templates-load-primary` | `two-documents` | `source-templates` | `literal` | `never-assembled` | `175-242` | `templates-load` | `—` |
| `templates-load-overlay` | `two-documents` | `source-templates` | `literal` | `never-assembled` | `243-243` | `templates-load` | `—` |
| `templates-load-value` | `two-documents` | `source-templates` | `literal` | `never-assembled` | `244-281` | `templates-load` | `—` |
| `templates-source` | `to-an-argv` | `source-templates` | `literal` | `whole-word-or-nothing` | `282-290` | `resolution-and-expansion` | `—` |
| `resolution-and-expansion` | `to-an-argv` | `source-templates` | `composite` | `whole-word-or-nothing` | `282-463` | `source-templates` | `templates-source`, `templates-require`, `templates-expand`, `match-values`, `declared-slots`, `templates-unresolved` |
| `templates-require` | `to-an-argv` | `source-templates` | `literal` | `whole-word-or-nothing` | `291-316` | `resolution-and-expansion` | `—` |
| `templates-expand` | `to-an-argv` | `source-templates` | `literal` | `whole-word-or-nothing` | `317-368` | `resolution-and-expansion` | `—` |
| `match-values` | `to-an-argv` | `source-templates` | `literal` | `whole-word-or-nothing` | `369-431` | `resolution-and-expansion` | `—` |
| `declared-slots` | `to-an-argv` | `source-templates` | `literal` | `whole-word-or-nothing` | `432-439` | `resolution-and-expansion` | `—` |
| `templates-unresolved` | `to-an-argv` | `source-templates` | `literal` | `whole-word-or-nothing` | `440-463` | `resolution-and-expansion` | `—` |
| `compile-vocabulary` | `two-documents` | `source-templates` | `literal` | `never-assembled` | `464-501` | `reading-and-whole-document-validation` | `—` |
| `reading-and-whole-document-validation` | `two-documents` | `source-templates` | `composite` | `never-assembled` | `464-672` | `source-templates` | `compile-vocabulary`, `read-primary`, `read-overlay`, `parse-and-validate`, `validate-document-nodes`, `validate-document-duplicates`, `validate-document-report` |
| `read-primary` | `two-documents` | `source-templates` | `literal` | `never-assembled` | `502-526` | `reading-and-whole-document-validation` | `—` |
| `read-overlay` | `two-documents` | `source-templates` | `literal` | `never-assembled` | `527-546` | `reading-and-whole-document-validation` | `—` |
| `parse-and-validate` | `two-documents` | `source-templates` | `literal` | `never-assembled` | `547-585` | `reading-and-whole-document-validation` | `—` |
| `validate-document-nodes` | `two-documents` | `source-templates` | `literal` | `never-assembled` | `586-608` | `reading-and-whole-document-validation` | `—` |
| `validate-document-duplicates` | `two-documents` | `source-templates` | `literal` | `never-assembled` | `609-641` | `reading-and-whole-document-validation` | `—` |
| `validate-document-report` | `two-documents` | `source-templates` | `literal` | `never-assembled` | `642-672` | `reading-and-whole-document-validation` | `—` |
| `validate-node-shape` | `template-law` | `source-templates` | `literal` | `words-not-shell` | `673-694` | `node-and-template-rules` | `—` |
| `node-and-template-rules` | `template-law` | `source-templates` | `composite` | `words-not-shell` | `673-812` | `source-templates` | `validate-node-shape`, `validate-node-one-argument`, `validate-node-result`, `validate-template-signature`, `validate-template-comment-start`, `validate-template-split`, `validate-template-word-zero`, `validate-template-cardinality` |
| `validate-node-one-argument` | `template-law` | `source-templates` | `literal` | `words-not-shell` | `695-721` | `node-and-template-rules` | `—` |
| `validate-node-result` | `template-law` | `source-templates` | `literal` | `words-not-shell` | `722-737` | `node-and-template-rules` | `—` |
| `validate-template-signature` | `template-law` | `source-templates` | `literal` | `words-not-shell` | `738-752` | `node-and-template-rules` | `—` |
| `validate-template-comment-start` | `template-law` | `source-templates` | `literal` | `words-not-shell` | `753-760` | `node-and-template-rules` | `—` |
| `validate-template-split` | `template-law` | `source-templates` | `literal` | `words-not-shell` | `761-772` | `node-and-template-rules` | `—` |
| `validate-template-word-zero` | `template-law` | `source-templates` | `literal` | `words-not-shell` | `773-799` | `node-and-template-rules` | `—` |
| `validate-template-cardinality` | `template-law` | `source-templates` | `literal` | `words-not-shell` | `800-812` | `node-and-template-rules` | `—` |
| `shell-word-scan-state` | `template-law` | `source-templates` | `literal` | `words-not-shell` | `813-823` | `word-scanning` | `—` |
| `word-scanning` | `template-law` | `source-templates` | `composite` | `words-not-shell` | `813-895` | `source-templates` | `shell-word-scan-state`, `contains-shell-comment-start`, `parse-template-word`, `whole-substitution` |
| `contains-shell-comment-start` | `template-law` | `source-templates` | `literal` | `words-not-shell` | `824-861` | `word-scanning` | `—` |
| `parse-template-word` | `template-law` | `source-templates` | `literal` | `words-not-shell` | `862-889` | `word-scanning` | `—` |
| `whole-substitution` | `template-law` | `source-templates` | `literal` | `words-not-shell` | `890-895` | `word-scanning` | `—` |
| `diagnostic-constructors` | `template-law` | `source-templates` | `literal` | `words-not-shell` | `896-912` | `diagnostics` | `—` |
| `diagnostics` | `template-law` | `source-templates` | `composite` | `words-not-shell` | `896-975` | `source-templates` | `diagnostic-constructors`, `render-diagnostics`, `location-rendering` |
| `render-diagnostics` | `template-law` | `source-templates` | `literal` | `words-not-shell` | `913-957` | `diagnostics` | `—` |
| `location-rendering` | `template-law` | `source-templates` | `literal` | `words-not-shell` | `958-975` | `diagnostics` | `—` |
| `templates-keys` | `to-an-argv` | `source-templates` | `literal` | `whole-word-or-nothing` | `976-985` | `source-templates` | `—` |
...
| `source-named` | `source-index` | `source-named` | `root` | `—` | `1-1158` | `—` | `named-capture`, `named-diagnostics`, `named-compile`, `named-fold`, `named-resolve`, `named-lookups` |
| `named-capture` | `two-documents` | `source-named` | `literal` | `never-assembled` | `1-404` | `source-named` | `—` |
| `named-diagnostics` | `two-documents` | `source-named` | `literal` | `never-assembled` | `405-420` | `source-named` | `—` |
| `named-compile` | `template-law` | `source-named` | `literal` | `words-not-shell` | `421-558` | `source-named` | `—` |
| `named-fold` | `two-documents` | `source-named` | `literal` | `never-assembled` | `559-799` | `source-named` | `—` |
| `named-resolve` | `two-documents` | `source-named` | `literal` | `never-assembled` | `800-1123` | `source-named` | `—` |
| `named-lookups` | `two-documents` | `source-named` | `literal` | `never-assembled` | `1124-1158` | `source-named` | `—` |
...
contain 3,810 lines, divided below by the manifest's ownership
blocks. Templates, run and channel split across chapters; the remaining roots
are owned whole.

| Slice | Page | Owned lines |
|---|---|---:|
| `understands-neither` | `01-orientation.md` | 293 |
| `rules-about-names` | `02-the-names.md` | 316 |
| `never-assembled` | `03-two-documents.md` | 1,346 |
