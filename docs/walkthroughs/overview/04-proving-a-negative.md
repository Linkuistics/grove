...
<!-- fragment «surface-closure-tests» owner="closure-proved" source="crates/grove/src/cli.rs" lines="99-184" parent="source-command-surface" -->
...
<!-- fragment «tests-module-opening» owner="closure-proved" source="crates/grove/src/cli.rs" lines="99-102" parent="surface-closure-tests" -->
````rust
#[cfg(test)]
mod tests {
    use super::Cli;
...
<!-- fragment «closure-test-doc» owner="closure-proved" source="crates/grove/src/cli.rs" lines="157-161" parent="surface-closure-tests" -->
````rust
...
<!-- fragment «closure-test-subcommands» owner="closure-proved" source="crates/grove/src/cli.rs" lines="162-172" parent="surface-closure-tests" -->
````rust
    #[test]
...
<!-- fragment «closure-test-arguments» owner="closure-proved" source="crates/grove/src/cli.rs" lines="173-184" parent="surface-closure-tests" -->
````rust
...
<!-- fragment «describes-test-doc» owner="closure-proved" source="crates/grove/src/cli.rs" lines="141-146" parent="surface-closure-tests" -->
````rust
...
<!-- fragment «describes-test» owner="closure-proved" source="crates/grove/src/cli.rs" lines="147-156" parent="surface-closure-tests" -->
````rust
    #[test]
...
<!-- fragment «undescribed-doc-purpose» owner="closure-proved" source="crates/grove/src/cli.rs" lines="103-106" parent="surface-closure-tests" -->
````rust
...
<!-- fragment «undescribed-arguments» owner="closure-proved" source="crates/grove/src/cli.rs" lines="120-129" parent="surface-closure-tests" -->
````rust
...
<!-- fragment «undescribed-subcommands» owner="closure-proved" source="crates/grove/src/cli.rs" lines="130-140" parent="surface-closure-tests" -->
````rust
...
<!-- fragment «undescribed-doc-twice» owner="closure-proved" source="crates/grove/src/cli.rs" lines="107-116" parent="surface-closure-tests" -->
````rust
...
<!-- fragment «undescribed-doc-empty» owner="closure-proved" source="crates/grove/src/cli.rs" lines="117-119" parent="surface-closure-tests" -->
````rust
