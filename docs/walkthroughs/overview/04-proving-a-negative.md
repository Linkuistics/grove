...
The binary tests two different contracts: exactly one subcommand, `view`, and
...
second now exercises a real viewer argument as well as its command.
...
<!-- fragment «surface-closure-tests» owner="closure-proved" source="crates/grove/src/cli.rs" lines="74-156" parent="source-command-surface" -->
...
<!-- fragment «tests-module-opening» owner="closure-proved" source="crates/grove/src/cli.rs" lines="74-77" parent="surface-closure-tests" -->
````rust
#[cfg(test)]
mod tests {
    use super::Cli;
...
collects every subcommand and requires exactly `["view"]`. It separately
...
selector. Adding any second command or bare selector fails this test.

<!-- fragment «closure-test-doc» owner="closure-proved" source="crates/grove/src/cli.rs" lines="132-136" parent="surface-closure-tests" -->
````rust
...
result with the single permitted viewer command.

<!-- fragment «closure-test-subcommands» owner="closure-proved" source="crates/grove/src/cli.rs" lines="137-144" parent="surface-closure-tests" -->
````rust
    #[test]
...
<!-- fragment «closure-test-arguments» owner="closure-proved" source="crates/grove/src/cli.rs" lines="145-156" parent="surface-closure-tests" -->
````rust
...
its full command path. It protects the viewer command and WORKTREE argument;
it does not establish whether an existing description is accurate.

<!-- fragment «describes-test-doc» owner="closure-proved" source="crates/grove/src/cli.rs" lines="116-121" parent="surface-closure-tests" -->
````rust
...
<!-- fragment «describes-test» owner="closure-proved" source="crates/grove/src/cli.rs" lines="122-131" parent="surface-closure-tests" -->
````rust
    #[test]
...
<!-- fragment «undescribed-doc-purpose» owner="closure-proved" source="crates/grove/src/cli.rs" lines="78-81" parent="surface-closure-tests" -->
````rust
...
<!-- fragment «undescribed-arguments» owner="closure-proved" source="crates/grove/src/cli.rs" lines="95-104" parent="surface-closure-tests" -->
````rust
...
<!-- fragment «undescribed-subcommands» owner="closure-proved" source="crates/grove/src/cli.rs" lines="105-115" parent="surface-closure-tests" -->
````rust
...
<!-- fragment «undescribed-doc-twice» owner="closure-proved" source="crates/grove/src/cli.rs" lines="82-91" parent="surface-closure-tests" -->
````rust
...
<!-- fragment «undescribed-doc-empty» owner="closure-proved" source="crates/grove/src/cli.rs" lines="92-94" parent="surface-closure-tests" -->
````rust
