...
fn pending_manifest_with_checkpoint(
    ...
    let observed_entries = digest_root_entries_at(&original_tree_directory).with_context(|| {
        format!(
...
mod tests {
    use super::{
        ...
        recover_pending, FinishRecovery, PreparedTransaction, MANIFEST_FILE, READY_FILE,
    };
    use crate::repo;
